...
from classes import Ground, Dino, Obstacle, Flying_Obstacle
import os
...
# FILES
HS_FILE = open("C:/Users/dhruv/Desktop/PyGame/CTON(1)/highscore.txt.txt", "r")
high_score = HS_FILE.read().split(" ")[1:][0]
...
def reset():
	...
	if score and score >= high_score:
		high_score = score
		high_score_file = open("C:/Users/dhruv/Desktop/PyGame/CTON(1)/highscore.txt.txt", "w+")
		high_score_string = str(high_score)
		high_score_file.write(user_text + ' ' + high_score_string)
...
user_text = ''
input_rect=pygame.Rect(500,350,140,32)
user_text_font=pygame.font.SysFont("comicsans",20)
title_font=pygame.font.SysFont("comicsans",30)
taking_username = True
...
while running:
	...
	if taking_username:
		pygame.draw.rect(win,(255,0,0),input_rect,2)
		title_label=title_font.render('Enter your name -__',1,(255,255,255))
		win.blit(title_label,(WIDTH/2-title_label.get_width()/2,300))
		user_text_label=user_text_font.render(user_text,1,(255,255,255))  
		win.blit(user_text_label,(input_rect.x+10,input_rect.y))       
